...
export const EN_ANALYSE = {
  ...
  'Reseau et HTTP': 'Network and HTTP',
  'Lire et mesurer': 'Read and measure',
  'Chercher et comparer': 'Search and compare',
  'Produire': 'Produce',

  /* --------------------- Identifiants et leur horodatage ------------------- */
  'Identifiant reconnu': 'Identifier recognised',
  'lecture(s) possible(s)': 'possible reading(s)',
  'Date de creation': 'Created at',
  'Anciennete': 'Age',
  'Machine': 'Machine',
  'Processus': 'Process',
  'Sequence dans la milliseconde': 'Sequence within the millisecond',
  'Compteur': 'Counter',
  'Horloge': 'Clock sequence',
  'Noeud': 'Node',
  'Noeud tire au hasard': 'Node drawn at random',
  'non — adresse de machine reelle': 'no - a real machine address',
  'Secondes depuis l origine': 'Seconds since the epoch',
  'Partie aleatoire': 'Random part',
  'Cas particulier': 'Special case',
  'Variante': 'Variant',
  'Plusieurs lectures tiennent : seule la source de l identifiant dit laquelle est la bonne.':
    'Several readings hold: only the source of the identifier says which one is right.',
  'UUID nul (nil)': 'nil UUID',
  'UUID maximal (max)': 'max UUID',
  'RFC 9562 (anciennement 4122)': 'RFC 9562 (formerly 4122)',
  'reservee NCS (heritee)': 'reserved for NCS (legacy)',
  'reservee Microsoft': 'reserved for Microsoft',
  'reservee pour l avenir': 'reserved for future use',
  'v1 — horodatage et adresse de machine': 'v1 - timestamp and machine address',
  'v2 — variante DCE, rare': 'v2 - DCE variant, rare',
  'v3 — empreinte MD5 d un nom': 'v3 - MD5 digest of a name',
  'v4 — aleatoire': 'v4 - random',
  'v5 — empreinte SHA-1 d un nom': 'v5 - SHA-1 digest of a name',
  'v6 — comme v1, champs reordonnes pour trier': 'v6 - like v1, fields reordered to sort',
  'v7 — horodatage en millisecondes puis hasard': 'v7 - millisecond timestamp then randomness',
  'v8 — libre, defini par l application': 'v8 - free, defined by the application',
  'version inconnue': 'unknown version',
  'horodatage illisible': 'unreadable timestamp',
  'anterieure a 1970 : lecture probablement fausse':
    'before 1970: the reading is probably wrong',
  'plus d un an dans le futur : lecture probablement fausse':
    'more than a year in the future: the reading is probably wrong',
  'aujourd hui': 'today',
  'hier': 'yesterday',
